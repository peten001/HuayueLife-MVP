...
data class ClaimedV2PrintJob(
    ...
    val adapter: String,
    val renderProtocol: String,
    val canonicalTemplateVersion: String,
    val renderedPayloadSha256: String,
    val renderedPayloadByteLength: Int,
    val paperWidthMm: Int? = null,
    val widthDots: Int? = null,
    val payloadTransport: String,
