...
.settlement-adjustment-dialog h3 { margin: 0; color: var(--cashier-shell-text); font-size: 22px; font-weight: 750; line-height: 1.25; }
.settlement-adjustment-dialog__close {
  ...
  place-items: center;
  padding: 0;
  border: 1px solid var(--cashier-white-alpha-07);
  border-radius: var(--cashier-radius-sm);
  color: var(--cashier-shell-muted);
  background: var(--cashier-white-alpha-03);
  font-size: 27px;
  font-weight: 400;
  line-height: 1;
}
.settlement-adjustment-dialog__controls { display: grid; gap: 8px; margin-top: 18px; }
.settlement-adjustment-dialog__control-label { margin: 0; color: var(--cashier-shell-text); font-size: 14px; font-weight: 650; line-height: 1.35; }
...
.settlement-adjustment-dialog__input-shell:focus-within { border-color: var(--cashier-green); outline-color: var(--cashier-green-alpha-35); }
.settlement-adjustment-dialog__input-shell.is-invalid { border-color: var(--cashier-danger); background: var(--cashier-red-alpha-08); }
.settlement-adjustment-dialog__mode-switch { display: grid; grid-template-columns: 1fr 1fr; padding: 3px; border-radius: 9px; background: var(--cashier-white-alpha-05); }
...
.settlement-adjustment-dialog__mode-switch button.is-selected { border-color: var(--cashier-green-alpha-35); color: var(--cashier-green); background: var(--cashier-green-alpha-13); }
...
.settlement-adjustment-dialog__message.is-visible { color: var(--cashier-danger-action-text); }
.settlement-adjustment-dialog__rounding-row {
  ...
  margin-top: 4px;
  padding: 12px 0;
  border-top: 1px solid var(--cashier-shell-border);
  border-bottom: 1px solid var(--cashier-shell-border);
}
.settlement-adjustment-dialog__rounding-row > div { display: grid; gap: 3px; min-width: 0; }
.settlement-adjustment-dialog__rounding-row strong { color: var(--cashier-shell-text); font-size: 14px; font-weight: 650; }
.settlement-adjustment-dialog__rounding-row span { color: var(--cashier-shell-muted); font-size: 12px; line-height: 1.35; }
...
.settlement-adjustment-dialog__switch-track { position: relative; display: block; width: 48px; height: 28px; border-radius: 999px; background: var(--cashier-white-alpha-14); cursor: pointer; transition: background-color 140ms ease; }
.settlement-adjustment-dialog__switch-track::after { position: absolute; top: 3px; left: 3px; width: 22px; height: 22px; border-radius: 50%; background: var(--cashier-shell-text); box-shadow: var(--cashier-shadow-sm); content: ''; transition: transform 140ms ease; }
...
.settlement-adjustment-dialog__switch input:focus-visible + .settlement-adjustment-dialog__switch-track { outline: 2px solid var(--cashier-green); outline-offset: 3px; }
...
.settlement-adjustment-dialog__summary dt { min-width: 0; color: var(--cashier-shell-muted); font-size: 14px; font-weight: 500; line-height: 1.45; }
.settlement-adjustment-dialog__summary dd { margin: 0; color: var(--cashier-shell-text); font-size: 15px; font-variant-numeric: tabular-nums; font-weight: 650; line-height: 1.45; white-space: nowrap; }
.settlement-adjustment-dialog__summary .is-deduction { color: var(--cashier-danger-action-text); font-weight: 700; }
.settlement-adjustment-dialog__summary .is-payable dt,
.settlement-adjustment-dialog__summary .is-payable dd { margin-top: 3px; padding-top: 11px; border-top: 1px solid var(--cashier-shell-border); }
.settlement-adjustment-dialog__summary .is-payable dt { color: var(--cashier-shell-text); font-size: 15px; font-weight: 650; }
.settlement-adjustment-dialog__summary .is-payable dd { color: var(--cashier-green); font-size: 21px; font-weight: 750; }
...
.settlement-adjustment-dialog button:focus-visible { outline-color: var(--cashier-green); }
...
.settlement-adjustment-dialog__cancel { color: var(--cashier-shell-text); background: var(--cashier-white-alpha-05); }
.settlement-adjustment-dialog__clear { color: var(--cashier-danger-action-text); background: var(--cashier-red-alpha-08); }
.settlement-adjustment-dialog__confirm { border-color: var(--cashier-green); color: var(--cashier-shell-950); background: var(--cashier-green); }
...
@media (hover: hover) {
  ...
  .settlement-adjustment-dialog__cancel:hover:not(:disabled) { color: var(--cashier-shell-text); background: var(--cashier-white-alpha-08); }
  .settlement-adjustment-dialog__mode-switch button:hover:not(:disabled):not(.is-selected) { color: var(--cashier-shell-text); background: var(--cashier-white-alpha-05); }
  .settlement-adjustment-dialog__clear:hover:not(:disabled) { border-color: var(--cashier-red-alpha-45); background: var(--cashier-red-alpha-10); }
  .settlement-adjustment-dialog__confirm:hover:not(:disabled) { background: var(--cashier-green-strong); }
}
