            ...
            withContext(Dispatchers.IO) {
                ...
                runCatching {
                    ...
                    settings.applyRemoteConfig(
                        ...
                        // A stale readiness report is not a server-side printer disablement.
...
internal fun connectorControlUi(
    ...
    val state = when {
        ...
        !(snapshot.remoteStartAllowed || snapshot.connectorEnabled) -> ConnectorVisualState.OFF
    ...
    return ConnectorControlUi(
        checked = snapshot.remoteStartAllowed || snapshot.connectorEnabled,
        state = state,
