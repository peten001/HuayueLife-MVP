...
object ConnectorPrintExecutionPolicy {
    /** Server capability gate; USB status/readiness is deliberately excluded. */
    fun remoteStartBlockCode(
        ...
        remote.boundPrinterChannelType != "LOCAL_USB_ESCPOS" -> "PRINT_CHANNEL_NOT_IMPLEMENTED"
