...
const zh = {
  ...
  merchantOpen: '营业中',
  merchantClosed: '休息中',
  googleMapsNavigation: 'Google Maps / 导航',
  copyGoogleMapsLink: '复制 Google Maps 链接',
  openMiniappMap: '小程序地图打开',
  googleMapsLinkCopied: '已复制 Google Maps 链接，请在浏览器或 Google Maps 中打开',
  googleMapsLinkCopyFailed: '复制失败，请稍后重试',
  merchantLocationMissing: '暂无商家定位信息，请复制 Google Maps 链接',
  miniappMapOpenFailed: '无法打开地图，请复制 Google Maps 链接',
  callMerchant: '拨打',
...
const vi: typeof zh = {
  ...
  googleMapsNavigation: 'Google Maps / Chỉ đường',
  copyGoogleMapsLink: 'Sao chép liên kết Google Maps',
  openMiniappMap: 'Mở bằng bản đồ mini app',
  googleMapsLinkCopied: 'Đã sao chép liên kết Google Maps, hãy mở trong trình duyệt hoặc Google Maps',
  googleMapsLinkCopyFailed: 'Sao chép thất bại, vui lòng thử lại',
  merchantLocationMissing: 'Chưa có vị trí cửa hàng, vui lòng sao chép liên kết Google Maps',
  miniappMapOpenFailed: 'Không thể mở bản đồ, vui lòng sao chép liên kết Google Maps',
  callMerchant: 'Gọi',
...
const en: typeof zh = {
  ...
  googleMapsNavigation: 'Google Maps / Navigate',
  copyGoogleMapsLink: 'Copy Google Maps link',
  openMiniappMap: 'Open mini app map',
  googleMapsLinkCopied: 'Google Maps link copied. Open it in a browser or Google Maps',
  googleMapsLinkCopyFailed: 'Copy failed, please try again',
  merchantLocationMissing: 'Merchant location is unavailable. Please copy the Google Maps link',
  miniappMapOpenFailed: 'Unable to open map. Please copy the Google Maps link',
  callMerchant: 'Call',
