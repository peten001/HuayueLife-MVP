...
const zh = {
  ...
  profileEditIntroDesc: '这里可以选择头像和昵称，不影响正常点餐。',
  profileEditHint: '头像会先保存在本机；昵称填写后可同步到微信资料。',
...
const vi: typeof zh = {
  ...
  profileEditIntroDesc: 'Bạn có thể chọn ảnh đại diện và biệt danh mà không ảnh hưởng đến việc đặt món.',
  profileEditHint: 'Ảnh đại diện sẽ được lưu trên máy này trước; biệt danh có thể đồng bộ vào hồ sơ WeChat.',
...
const en: typeof zh = {
  ...
  profileEditIntroDesc: 'You can choose an avatar and nickname without affecting ordering.',
  profileEditHint: 'The avatar is saved locally first; the nickname can be synced to your WeChat profile.',
