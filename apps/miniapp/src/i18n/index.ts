...
const zh = {
  ...
  deliveryRangeExceeded: '当前地址超出商家配送范围，请重新选择地址',
...
const vi: typeof zh = {
  ...
  deliveryRangeExceeded: 'Địa chỉ hiện tại nằm ngoài phạm vi giao hàng của cửa hàng, vui lòng chọn lại địa chỉ',
...
const en: typeof zh = {
  ...
  deliveryRangeExceeded: 'The current address is outside the merchant delivery range. Please choose another address.',
