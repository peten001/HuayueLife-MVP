...
const zh = {
  ...
  loggedIn: '已登录',
  bindPhone: '绑定手机号',
  phoneLinkingUnavailable: '手机号绑定暂未开放',
...
const vi: typeof zh = {
  ...
  phoneLinkingUnavailable: 'Tính năng liên kết số điện thoại chưa được mở',
...
const en: typeof zh = {
  ...
  phoneLinkingUnavailable: 'Phone linking is not available yet',
