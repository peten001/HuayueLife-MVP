...
const zh = {
  ...
  reviewPhotos: '添加图片',
  reviewPhotosHint: '最多 6 张，单张不超过 5MB',
  ...
  directReviewLimitHint: '无需订单即可评价，每位用户对同一商家可提交 1 条',
  ...
  reviewImageTooLarge: '单张评价图片不能超过 5MB',
...
const vi: typeof zh = {
  ...
  reviewPhotosHint: 'Tối đa 6 ảnh, mỗi ảnh không quá 5MB',
  ...
  directReviewLimitHint: 'Không cần đơn hàng. Mỗi người dùng có thể gửi 1 đánh giá trực tiếp cho mỗi cửa hàng',
  ...
  reviewImageTooLarge: 'Mỗi ảnh đánh giá không được vượt quá 5MB',
...
const en: typeof zh = {
  ...
  galleryProduct: 'Dishes',
  galleryEnvironment: 'Dining area',
  ...
  reviewPhotosHint: 'Up to 6 photos, 5MB each',
  ...
  directReviewLimitHint: 'No order is required. Each user can post one direct review per merchant',
  ...
  reviewImageTooLarge: 'Each review photo must be 5MB or smaller',
