...
const zh = {
  ...
  merchantClaimed: '商家已入驻',
  merchantUnclaimed: '平台收录',
  merchantClaimTitle: '这是您的商家？',
  merchantClaimDescription: '免费认领后，可完善商家资料并管理门店服务。',
  merchantClaimAction: '免费认领',
  merchantIntro: '商家简介',
  signatureDishes: '招牌菜',
  merchantHotRecommendations: '热销推荐',
  environmentPhotos: '商家环境',
  galleryCover: '封面',
  galleryStore: '门店外观',
  galleryProduct: '商品',
  galleryEnvironment: '商家环境',
  galleryCategories: '商家图片分类',
  viewMore: '查看更多',
  collapse: '收起',
  services: '服务设施',
  chineseService: '中文服务',
  ...
  freeWifi: '免费 Wi-Fi',
  supportsPickup: '到店自取',
  supportsDelivery: '商家配送',
  supportsQrOrder: '支持扫码点餐',
  back: '返回',
  shareMerchant: '分享商家',
  ...
  cartTitle: '购物车',
  checkoutTitle: '确认订单',
  orderingUnavailableTitle: '页面暂不可用',
  orderingUnavailableMessage: '当前页面暂不可用，请返回首页浏览商家信息。',
  backHome: '返回首页',
  ...
  homeMerchantLoadFailed: '商家加载失败',
  homeMerchantLoadFailedHint: '网络或服务暂时不可用，请重试。',
  homeRetry: '重试',
  homeLoadingMore: '正在加载更多商家...',
  homeLoadMoreFailed: '更多商家加载失败',
  allMerchants: '全部商家',
  scanOrder: '扫码点餐',
  ...
  aboutLine1: '云桥 Life 是一个本地生活信息展示平台，致力于为用户提供周边商家资料、地址、联系方式及营业信息等基础信息服务。',
  aboutLine2: '用户可通过本平台了解附近生活服务信息，便于日常查询与出行参考。',
  editProfile: '编辑资料',
  ...
  loggingIn: '登录中...',
  loginPrivacyPrefix: '我已阅读并同意',
  privacyProtectionGuide: '用户隐私保护指引',
  privacyAgreeRequired: '请先阅读并同意用户隐私保护指引',
  ...
  timelinePreviewOrderingHint: '请先点击底部“前往小程序”，再点餐',
  ...
  writeReview: '写评价',
  reviewSourceOrder: '消费后评价',
  reviewSourceDirect: '直接评价',
  reviewMerchantHint: '分享这次真实用餐体验，帮助更多人做选择',
  directReviewMerchantHint: '分享你对这家商家的真实体验，帮助更多人做选择',
  reviewOrderContext: '本次订单',
  reviewRating: '总体评分',
  reviewRatingRequired: '请选择总体评分',
  reviewRating1: '很不满意',
  reviewRating2: '不太满意',
  reviewRating3: '还可以',
  reviewRating4: '比较满意',
  reviewRating5: '非常满意',
  reviewContent: '说说你的体验',
  reviewContentPlaceholder: '菜品味道、服务或环境怎么样？真实具体的感受更有帮助。',
  reviewPhotos: '添加图片',
  reviewPhotosHint: '最多 6 张，选择后自动压缩',
  compressingReviewImages: '正在压缩图片...',
  reviewImageCompressFailed: '图片处理失败，请重新选择',
  anonymousReview: '匿名评价',
  anonymousReviewHint: '公开展示为“匿名用户”',
  submitReview: '提交评价',
  submittingReview: '正在提交...',
  reviewSubmitted: '评价已发布',
  reviewPending: '评价已提交审核',
  reviewPendingHint: '内容安全检查通过后会公开展示',
  reviewAlreadySubmitted: '这笔订单已评价',
  directReviewAlreadySubmitted: '你已直接评价过这家商家',
  reviewHidden: '评价暂不可见',
  reviewHiddenHint: '该评价当前不在公开列表中',
  reviewUnavailable: '这笔订单当前不可评价',
  reviewWindowHint: '订单完成后 7 天内可评价',
  reviewLoadFailed: '评价加载失败，请稍后再试',
  retry: '重试',
  reviewSubmitFailed: '评价提交失败，请稍后再试',
  reviewImageUploadFailed: '图片上传失败，请重试',
  reviewImageUploadNetworkFailed: '图片上传失败，请检查网络后重试',
  reviewImageTooLarge: '图片压缩后仍超过 5MB，请换一张',
  reviewImageTypeInvalid: '评价图片仅支持 JPG、PNG 或 WebP',
  reviewImageInvalid: '图片无法识别，请重新选择',
  reviewImageRequired: '请选择评价图片',
  reviewImageLimitReached: '每条评价最多上传 6 张图片',
  reviewImageLoadFailed: '图片加载失败',
  reviewLoginRequired: '请先登录后再上传图片',
  anonymousUser: '匿名用户',
  reviewCount: '{count} 条评价',
  noReviews: '暂无用户评价',
  noReviewsHint: '还没有评价，来分享你的真实体验吧。',
  viewAllReviews: '查看全部评价',
  goReview: '去评价',
  viewReview: '查看评价',
  reviewPhoto: '评价图片 {index}',
  removeReviewPhoto: '删除第 {index} 张图片',
  reviewLoadMore: '加载更多',
  reviewNoMore: '已经到底了',
  ...
  dineInSubmittedToTableBill: '订单已提交至桌台账单',
...
const vi: typeof zh = {
  ...
  favoriteUpdateFailed: 'Không thể cập nhật mục đã lưu, vui lòng thử lại',
  homeTitle: '云桥 Life',
  ...
  merchantClaimed: 'Đã tham gia YunQiao',
  merchantUnclaimed: 'Có mặt trên YunQiao',
  merchantClaimTitle: 'Đây là cửa hàng của bạn?',
  merchantClaimDescription: 'Nhận miễn phí để hoàn thiện thông tin và quản lý dịch vụ cửa hàng.',
  merchantClaimAction: 'Nhận miễn phí',
  merchantIntro: 'Giới thiệu cửa hàng',
  signatureDishes: 'Món đặc trưng',
  merchantHotRecommendations: 'Món bán chạy',
  environmentPhotos: 'Ảnh không gian',
  galleryCover: 'Ảnh bìa',
  galleryStore: 'Mặt tiền',
  galleryProduct: 'Sản phẩm',
  galleryEnvironment: 'Không gian',
  galleryCategories: 'Danh mục ảnh cửa hàng',
  viewMore: 'Xem thêm',
  collapse: 'Thu gọn',
  services: 'Tiện ích',
  chineseService: 'Hỗ trợ tiếng Trung',
  privateRooms: 'Có phòng riêng',
  airConditioned: 'Có điều hòa',
  freeWifi: 'Wi-Fi miễn phí',
  supportsPickup: 'Tự đến lấy',
  supportsDelivery: 'Giao hàng bởi quán',
  supportsQrOrder: 'Hỗ trợ gọi món bằng mã QR',
  back: 'Quay lại',
  shareMerchant: 'Chia sẻ cửa hàng',
  merchantAddress: 'Địa chỉ cửa hàng',
  reload: 'Tải lại',
  menuTitle: 'Thực đơn',
  ...
  orderingUnavailableTitle: 'Trang tạm thời không khả dụng',
  orderingUnavailableMessage: 'Trang hiện tạm thời không khả dụng. Vui lòng quay lại trang chủ để xem thông tin cửa hàng.',
  ...
  homeMerchantLoadFailed: 'Không thể tải cửa hàng',
  homeMerchantLoadFailedHint: 'Mạng hoặc dịch vụ tạm thời không khả dụng. Vui lòng thử lại.',
  homeRetry: 'Thử lại',
  homeLoadingMore: 'Đang tải thêm cửa hàng...',
  homeLoadMoreFailed: 'Không thể tải thêm cửa hàng',
  ...
  aboutLine1: 'Yunqiao Life là nền tảng hiển thị thông tin đời sống địa phương, cung cấp các thông tin cơ bản như hồ sơ cửa hàng, địa chỉ, thông tin liên hệ và giờ hoạt động của các đơn vị xung quanh.',
  aboutLine2: 'Người dùng có thể tham khảo thông tin dịch vụ đời sống gần khu vực của mình để phục vụ nhu cầu tra cứu và di chuyển hằng ngày.',
  ...
  loginPrivacyPrefix: 'Tôi đã đọc và đồng ý với',
  privacyProtectionGuide: 'Hướng dẫn bảo vệ quyền riêng tư người dùng',
  privacyAgreeRequired: 'Vui lòng đọc và đồng ý với hướng dẫn bảo vệ quyền riêng tư trước',
  ...
  timelinePreviewOrderingHint: 'Hãy mở ứng dụng nhỏ bằng nút bên dưới để đặt món',
  ...
  reviewMerchant: 'Đánh giá cửa hàng',
  customerReviews: 'Đánh giá của khách',
  writeReview: 'Viết đánh giá',
  reviewSourceOrder: 'Đánh giá sau khi sử dụng',
  reviewSourceDirect: 'Đánh giá trực tiếp',
  reviewMerchantHint: 'Chia sẻ trải nghiệm thật để giúp mọi người lựa chọn dễ hơn',
  directReviewMerchantHint: 'Chia sẻ trải nghiệm của bạn về cửa hàng này để giúp người khác lựa chọn',
  reviewOrderContext: 'Đơn hàng này',
  reviewRating: 'Đánh giá chung',
  reviewRatingRequired: 'Vui lòng chọn số sao',
  reviewRating1: 'Rất không hài lòng',
  reviewRating2: 'Chưa hài lòng',
  reviewRating3: 'Bình thường',
  reviewRating4: 'Khá hài lòng',
  reviewRating5: 'Rất hài lòng',
  reviewContent: 'Chia sẻ trải nghiệm',
  reviewContentPlaceholder: 'Món ăn, dịch vụ hoặc không gian thế nào? Cảm nhận cụ thể sẽ hữu ích hơn.',
  reviewPhotos: 'Thêm ảnh',
  reviewPhotosHint: 'Tối đa 6 ảnh, tự động nén sau khi chọn',
  compressingReviewImages: 'Đang nén ảnh...',
  reviewImageCompressFailed: 'Xử lý ảnh thất bại, vui lòng chọn lại',
  anonymousReview: 'Đánh giá ẩn danh',
  anonymousReviewHint: 'Hiển thị công khai là “Người dùng ẩn danh”',
  submitReview: 'Gửi đánh giá',
  submittingReview: 'Đang gửi...',
  reviewSubmitted: 'Đã đăng đánh giá',
  reviewPending: 'Đã gửi đánh giá để duyệt',
  reviewPendingHint: 'Đánh giá sẽ hiển thị công khai sau khi vượt qua kiểm tra an toàn nội dung',
  reviewAlreadySubmitted: 'Đơn hàng này đã được đánh giá',
  directReviewAlreadySubmitted: 'Bạn đã gửi đánh giá trực tiếp cho cửa hàng này',
  reviewHidden: 'Đánh giá tạm thời không hiển thị',
  reviewHiddenHint: 'Đánh giá này hiện không có trong danh sách công khai',
  reviewUnavailable: 'Đơn hàng này hiện không thể đánh giá',
  reviewWindowHint: 'Có thể đánh giá trong vòng 7 ngày sau khi hoàn tất đơn',
  reviewLoadFailed: 'Không tải được đánh giá, vui lòng thử lại sau',
  retry: 'Thử lại',
  reviewSubmitFailed: 'Gửi đánh giá thất bại, vui lòng thử lại sau',
  reviewImageUploadFailed: 'Tải ảnh thất bại, vui lòng thử lại',
  reviewImageUploadNetworkFailed: 'Tải ảnh thất bại, vui lòng kiểm tra mạng và thử lại',
  reviewImageTooLarge: 'Ảnh vẫn vượt quá 5MB sau khi nén, vui lòng chọn ảnh khác',
  reviewImageTypeInvalid: 'Ảnh đánh giá chỉ hỗ trợ JPG, PNG hoặc WebP',
  reviewImageInvalid: 'Không thể nhận dạng ảnh, vui lòng chọn lại',
  reviewImageRequired: 'Vui lòng chọn ảnh đánh giá',
  reviewImageLimitReached: 'Mỗi đánh giá được tải lên tối đa 6 ảnh',
  reviewImageLoadFailed: 'Không tải được ảnh',
  reviewLoginRequired: 'Vui lòng đăng nhập trước khi tải ảnh',
  anonymousUser: 'Người dùng ẩn danh',
  reviewCount: '{count} đánh giá',
  noReviews: 'Chưa có đánh giá',
  noReviewsHint: 'Chưa có đánh giá. Hãy chia sẻ trải nghiệm của bạn.',
  viewAllReviews: 'Xem tất cả đánh giá',
  goReview: 'Đánh giá',
  viewReview: 'Xem đánh giá',
  reviewPhoto: 'Ảnh đánh giá {index}',
  removeReviewPhoto: 'Xóa ảnh thứ {index}',
  reviewLoadMore: 'Tải thêm',
  reviewNoMore: 'Đã hiển thị tất cả',
  ...
  category: 'Danh mục',
  dishCount: '{count} món',
  hotRecommendations: '🔥 Món bán chạy',
  searchDishes: 'Tìm món',
  searchResults: 'Kết quả tìm kiếm',
  salesCount: 'Đã bán {count}',
  hotRank: 'Bán chạy #{rank}',
  ...
  dineInSubmittedToTableBill: 'Đơn hàng đã được thêm vào hóa đơn tại bàn',
...
const en: typeof zh = {
  ...
  favoriteUpdateFailed: 'Could not update favorites. Please try again.',
  ...
  merchantClaimed: 'Merchant onboarded',
  merchantUnclaimed: 'Listed on YunQiao',
  merchantClaimTitle: 'Is this your business?',
  merchantClaimDescription: 'Claim it for free to complete your profile and manage store services.',
  merchantClaimAction: 'Claim for free',
  merchantIntro: 'About this merchant',
  signatureDishes: 'Signature dishes',
  merchantHotRecommendations: 'Best sellers',
  environmentPhotos: 'Venue photos',
  galleryCover: 'Cover photo',
  galleryStore: 'Storefront',
  galleryProduct: 'Products',
  galleryEnvironment: 'Business space',
  galleryCategories: 'Merchant image categories',
  viewMore: 'View more',
  collapse: 'Show less',
  services: 'Amenities',
  ...
  supportsDelivery: 'Merchant delivery',
  supportsQrOrder: 'In-store QR ordering supported',
  back: 'Back',
  shareMerchant: 'Share merchant',
  ...
  orderingUnavailableTitle: 'Page temporarily unavailable',
  orderingUnavailableMessage: 'This page is temporarily unavailable. Please return to the home page to browse merchant information.',
  backHome: 'Back Home',
  ...
  homeMerchantLoadFailed: 'Unable to load merchants',
  homeMerchantLoadFailedHint: 'The network or service is temporarily unavailable. Please try again.',
  homeRetry: 'Retry',
  homeLoadingMore: 'Loading more merchants...',
  homeLoadMoreFailed: 'Unable to load more merchants',
  ...
  aboutLine1: 'Yunqiao Life is a local lifestyle information platform that provides basic information such as nearby merchant profiles, addresses, contact details, and business hours.',
  aboutLine2: 'Users can browse nearby lifestyle service information for daily reference and travel planning.',
  ...
  privacyProtectionGuide: 'User Privacy Protection Guidelines',
  privacyAgreeRequired: 'Please read and agree to the privacy guidelines first',
  ...
  timelinePreviewOrderingHint: 'Open the Mini Program below to order',
  ...
  reviewMerchant: 'Review Merchant',
  customerReviews: 'Customer Reviews',
  writeReview: 'Write a review',
  reviewSourceOrder: 'Post-visit review',
  reviewSourceDirect: 'Direct review',
  reviewMerchantHint: 'Share your real experience to help others choose with confidence',
  directReviewMerchantHint: 'Share your experience with this merchant to help others choose',
  reviewOrderContext: 'This order',
  reviewRating: 'Overall rating',
  reviewRatingRequired: 'Please choose an overall rating',
  reviewRating1: 'Very dissatisfied',
  reviewRating2: 'Dissatisfied',
  reviewRating3: 'It was okay',
  reviewRating4: 'Satisfied',
  reviewRating5: 'Very satisfied',
  reviewContent: 'Share your experience',
  reviewContentPlaceholder: 'How were the food, service, or environment? Specific feedback is more helpful.',
  reviewPhotos: 'Add photos',
  reviewPhotosHint: 'Up to 6 photos, automatically compressed after selection',
  compressingReviewImages: 'Compressing photos...',
  reviewImageCompressFailed: 'Photo processing failed. Please choose it again.',
  anonymousReview: 'Post anonymously',
  anonymousReviewHint: 'Your name will appear as “Anonymous user”',
  submitReview: 'Submit Review',
  submittingReview: 'Submitting...',
  reviewSubmitted: 'Review published',
  reviewPending: 'Review submitted for approval',
  reviewPendingHint: 'The review will appear publicly after content safety checks pass',
  reviewAlreadySubmitted: 'This order has already been reviewed',
  directReviewAlreadySubmitted: 'You have already posted a direct review for this merchant',
  reviewHidden: 'Review temporarily hidden',
  reviewHiddenHint: 'This review is not currently shown in the public list',
  reviewUnavailable: 'This order cannot be reviewed right now',
  reviewWindowHint: 'Review within 7 days after order completion',
  reviewLoadFailed: 'Failed to load reviews. Please try again later.',
  retry: 'Retry',
  reviewSubmitFailed: 'Failed to submit review. Please try again later.',
  reviewImageUploadFailed: 'Failed to upload photo. Please try again.',
  reviewImageUploadNetworkFailed: 'Failed to upload photo. Check your connection and try again.',
  reviewImageTooLarge: 'This photo is still over 5MB after compression. Choose another.',
  reviewImageTypeInvalid: 'Review photos must be JPG, PNG, or WebP',
  reviewImageInvalid: 'This image could not be read. Please choose another one.',
  reviewImageRequired: 'Please choose a review photo',
  reviewImageLimitReached: 'Each review can include up to 6 photos',
  reviewImageLoadFailed: 'Photo failed to load',
  reviewLoginRequired: 'Please sign in before uploading photos',
  anonymousUser: 'Anonymous user',
  reviewCount: '{count} reviews',
  noReviews: 'No reviews yet',
  noReviewsHint: 'No reviews yet. Share your experience.',
  viewAllReviews: 'View all reviews',
  goReview: 'Review',
  viewReview: 'View Review',
  reviewPhoto: 'Review photo {index}',
  removeReviewPhoto: 'Remove photo {index}',
  reviewLoadMore: 'Load more',
  reviewNoMore: 'You have reached the end',
  ...
  hotRecommendations: '🔥 Best sellers',
  searchDishes: 'Search dishes',
  searchResults: 'Search results',
  salesCount: 'Sold {count}',
  hotRank: 'Bestseller #{rank}',
  ...
  dineInSubmittedToTableBill: 'Your order has been added to the table bill',
...
export function translateApiError(raw: unknown) {
  ...
  if (raw.includes('直接评价过')) return t('directReviewAlreadySubmitted');
  if (raw.includes('已经评价')) return t('reviewAlreadySubmitted');
  if (
    raw.includes('不可评价')
    || raw.includes('只有已完成订单可以评价')
    || raw.includes('评价期已结束')
  ) return t('reviewUnavailable');
  if (raw.includes('Review not found')) return t('reviewLoadFailed');
  if (raw.includes('评价图片不能超过')) return t('reviewImageTooLarge');
  if (raw.includes('仅支持 JPG')) return t('reviewImageTypeInvalid');
  if (raw.includes('图片无法识别')) return t('reviewImageInvalid');
  if (raw.includes('请选择评价图片')) return t('reviewImageRequired');
  if (raw.includes('最多上传 6 张图片')) return t('reviewImageLimitReached');
  if (raw.includes('评价图片凭证无效')) return t('reviewImageUploadFailed');
  return raw;
}
