...
const zh = {
  ...
  aboutTitle: '关于华越优选',
  aboutLine1: '面向北宁、北江华人的本地商家服务工具。',
  aboutLine2: '当前暂不提供在线支付和平台配送，具体服务由商家确认。',
  myOrders: '我的订单',
  editProfile: '编辑资料',
...
const vi: typeof zh = {
  ...
  aboutLine1: 'Công cụ dịch vụ cửa hàng địa phương dành cho người Hoa tại Bắc Ninh và Bắc Giang.',
  aboutLine2: 'Hiện chưa hỗ trợ thanh toán trực tuyến và giao hàng bởi nền tảng. Dịch vụ cụ thể sẽ được cửa hàng xác nhận.',
...
const en: typeof zh = {
  ...
  aboutLine1: 'A local merchant service tool for Chinese users in Bac Ninh and Bac Giang.',
  aboutLine2: 'Online payment and platform delivery are not provided at this stage. Services are confirmed by each merchant.',
  myOrders: 'My Orders',
