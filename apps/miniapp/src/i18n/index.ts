...
const zh = {
  ...
  anonymousUser: '匿名用户',
  reviewCount: '{count} 条真实评价',
  noReviews: '暂无用户评价',
  noReviewsHint: '完成订单后，可以分享真实体验。',
...
const vi: typeof zh = {
  ...
  reviewCount: '{count} đánh giá thật',
  noReviews: 'Chưa có đánh giá',
  noReviewsHint: 'Sau khi hoàn tất đơn, bạn có thể chia sẻ trải nghiệm thật.',
...
const en: typeof zh = {
  ...
  reviewCount: '{count} verified reviews',
  noReviews: 'No reviews yet',
  noReviewsHint: 'After completing an order, you can share your real experience.',
