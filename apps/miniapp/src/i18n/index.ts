...
const zh = {
  ...
  loading: '加载中...',
  noMerchants: '商家陆续入驻中',
  noMerchantsHint: '华越优选正在接入北宁、北江本地商家，更多服务即将开放。',
  ...
  mapNavigation: '导航',
  mapTest: '地图测试',
  chooseMapToTest: '选择地图进行测试',
  googleMaps: 'Google Maps',
  amap: '高德地图',
  systemMap: '系统地图',
  mapOpenFailed: '打开地图失败',
  mapAppUnavailable: '当前环境无法直接打开所选地图，将继续使用系统地图。',
  continueWithSystemMap: '继续使用系统地图',
  cancel: '取消',
  ...
  aboutTitle: '关于华越优选',
  aboutLine1: '面向北宁、北江华人的本地商家信息展示工具。',
  aboutLine2: '你可以查看商家信息、收藏感兴趣的店铺，并接收商家服务通知。',
  editProfile: '编辑资料',
...
const vi: typeof zh = {
  ...
  noMerchantsHint: 'HuaYue YouXuan đang kết nối các cửa hàng địa phương tại Bắc Ninh và Bắc Giang. Nhiều dịch vụ sẽ sớm được mở.',
  ...
  mapTest: 'Thử bản đồ',
  chooseMapToTest: 'Chọn bản đồ để thử',
  googleMaps: 'Google Maps',
  amap: 'Amap',
  systemMap: 'Bản đồ hệ thống',
  mapOpenFailed: 'Mở bản đồ thất bại',
  mapAppUnavailable: 'Môi trường hiện tại không thể mở trực tiếp bản đồ đã chọn. Sẽ tiếp tục bằng bản đồ hệ thống.',
  continueWithSystemMap: 'Tiếp tục với bản đồ hệ thống',
  cancel: 'Hủy',
  ...
  aboutTitle: 'Về Huayue Life',
  aboutLine1: 'Công cụ hiển thị thông tin cửa hàng địa phương dành cho người Hoa tại Bắc Ninh và Bắc Giang.',
  aboutLine2: 'Bạn có thể xem thông tin cửa hàng, lưu các cửa hàng quan tâm và nhận thông báo dịch vụ từ cửa hàng.',
  ...
  profileWelcomeTitle: 'Chào mừng đến với Huayue Life',
...
const en: typeof zh = {
  ...
  noMerchantsHint: 'HuaYue YouXuan is adding local merchants in Bac Ninh and Bac Giang. More services are coming soon.',
  ...
  mapTest: 'Map test',
  chooseMapToTest: 'Choose a map to test',
  googleMaps: 'Google Maps',
  amap: 'Amap',
  systemMap: 'System map',
  mapOpenFailed: 'Failed to open map',
  mapAppUnavailable: 'The selected map cannot be opened directly in the current environment. Continue with the system map instead.',
  continueWithSystemMap: 'Continue with system map',
  cancel: 'Cancel',
  ...
  aboutLine1: 'A local merchant information display tool for Chinese communities in Bac Ninh and Bac Giang.',
  aboutLine2: 'You can view merchant information, save interested stores, and receive merchant service notices.',
  ...
  profileWelcomeTitle: 'Welcome to Huayue Life',
