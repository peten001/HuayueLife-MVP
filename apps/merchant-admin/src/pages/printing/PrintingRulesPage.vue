...
<template>
  <section class="printing-auto-page mx-print-routing" aria-label="自动打印">
    ...
    <div class="mx-routing-columns"><section class="printer-purpose-section" aria-labelledby="front-desk-printers-title">
      ...
      <div v-else class="printer-purpose-empty"><p>尚未配置前台打印机</p></div>
    </section>
    ...
    <section class="printer-purpose-section" aria-labelledby="kitchen-printers-title">
      ...
      <div v-else class="printer-purpose-empty"><p>尚未配置厨房打印机</p></div>
    </section>
  </div></section>
...
.printing-assign-backdrop{z-index:80}
</style>
