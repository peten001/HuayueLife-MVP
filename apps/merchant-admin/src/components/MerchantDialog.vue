...
@media(max-width:768px){.m-dialog{width:100%;max-width:none;max-height:calc(100dvh - env(safe-area-inset-top) - 20px);margin:auto 0 0;border-radius:18px 18px 0 0}.m-dialog-body{padding:12px 18px calc(22px + env(safe-area-inset-bottom))}.m-dialog header{padding:14px 18px}}
