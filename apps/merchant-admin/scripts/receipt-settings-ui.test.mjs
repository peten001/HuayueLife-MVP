...
assert.equal((shell.match(/to="\/printing-center\/android-terminal"/g) ?? []).length, 0);
assert.doesNotMatch(shell, /printing-center__download|printing-center__help|printing-help/);
